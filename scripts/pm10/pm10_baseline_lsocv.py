...
# =========================================================
# 2. SADECE GEÇERLİ PM10 GÖZLEMLERİ
# =========================================================
...
print("\n==============================")
print("METEOROLOJI-ONLY LINEAR BASELINE")
...
for test_station in stations:
    ...
    # -----------------------------------------------------
    # Eğitim:
    # test istasyonu DIŞINDA kalan bütün istasyonlar
    # -----------------------------------------------------
    ...
    # -----------------------------------------------------
    # Test:
    # modelin hiç görmediği istasyon
    # -----------------------------------------------------
...
# =========================================================
# 11. BÜTÜN OUT-OF-STATION TAHMİNLER
# =========================================================
...
results_file = (
    output_dir
    / "pm10_linear_lsocv_sonuclar.csv"
)

predictions_file = (
    output_dir
    / "pm10_linear_lsocv_tahminler.csv"
)
...
print("\n==============================")
print("LINEAR BASELINE TAMAMLANDI")
print("==============================")
